...
if (isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] == TRUE) {
  header("Location: ./index.php"); // Use header function for redirection
  exit;
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (empty($user_login_err) && empty($user_password_err)) {
    ...
    $sql = "SELECT id, username, password, balance FROM users WHERE username = ? OR email = ?";
      ...
      <div class="col-lg-5">
        ...
        <div class="form-wrap border border-secondary rounded p-4">
          ...
          <form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" novalidate>
            ...
            <div class="mb-3">
              <input type="submit" class="btn btn-secondary form-control" name="submit" value="Log In">
            </div>
            <p class="mb-0">Don't have an account? <a href="./register.php" class="text-muted">Sign Up</a></p>
